...
void RunPattern::createDetecter()
{
    ...
    case BRIGHTNESS:
        ...
        break;
    case BRIGHTNESSLOWER:
        this->detecter = new BrightnessLowerDetecter(this->threshold);
        break;
    case BRIGHTNESSUPPER:
        this->detecter = new BrightnessUpperDetecter(this->threshold);
        break;
    case CLOCK:
