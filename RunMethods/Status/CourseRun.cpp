...
void CourseRun::createCourseL(){
    ...
    patterns.push_back(new RunPattern(LINE_TRACE, 80, DISTANCE, 560, 0.25, 0.01, 0.03, 60));
    patterns.push_back(new RunPattern(LINE_TRACE, 70, DISTANCE, 120, 0.55, 0.01, 0.03, 60));
    patterns.push_back(new RunPattern(LINE_TRACE, 70, DISTANCE, 80,  0.6, 0.01, 0.03, 60));//ここ変える３０0.55
    patterns.push_back(new RunPattern(LINE_TRACE, 80, DISTANCE, 250, 0.7, 0.01, 0.03, 60));
