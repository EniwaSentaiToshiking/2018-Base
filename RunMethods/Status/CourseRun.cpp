...
void CourseRun::createCourseR(){
    ...
    patterns.push_back(new RunPattern(LINE_TRACE, 50, DISTANCE, 200, 0.25, 0.03, 0.03, 50));
    patterns.push_back(new RunPattern(LINE_TRACE, 50, DISTANCE, 180, 0.35, 0.01, 0.05, 50));
    patterns.push_back(new RunPattern(LINE_TRACE, 50, DISTANCE, 220, 0.6, 0.01, 0.035, 50));
    patterns.push_back(new RunPattern(LINE_TRACE, 50, DISTANCE, 140, 0.45, 0.01, 0.04, 50));
    patterns.push_back(new RunPattern(LINE_TRACE, 50, DISTANCE, 260, 0.3, 0.03, 0.03, 50));
