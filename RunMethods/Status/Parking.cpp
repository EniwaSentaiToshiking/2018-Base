...
void Parking::createCourseR(){
    ...
    patterns.push_back(new RunPattern(LINE_TRACE, 15, GRAYLINE, 50, 1.0, 0.0, 0.00, 40, RIGHT));
    patterns.push_back(new RunPattern(LINE_TRACE, 5, DISTANCE, 10, 1.0, 0.0, 0.05, 70, LEFT));
    patterns.push_back(new RunPattern(STRAIGHT, 50, DISTANCE, 40));
}